 ...
 */
public class WorkstationAuthPlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public WorkstationAuthPlugin(AnnotatedServiceRegistry serviceRegistry) {
